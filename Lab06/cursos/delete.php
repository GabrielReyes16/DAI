...
<body>
    ...
    <form  name="formUpdate" action="delete_curso.php" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="creditos" name="creditos" value="<?php echo $creditos ?>" readonly>
        </div>
