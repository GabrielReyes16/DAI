...
<body>
    <div class="container">
        <h1>Editar Autor</h1>
        <form  name="formUpdate" action="update_autor.php" method="POST">
            <input type="hidden" name="autor_id" value="<?php echo $autor_id ?>">
            <div class="mb-3">
                <label for="nombres" class="form-label">Nombres</label>
                <input type="text" class="form-control" id="nombres" name="nombres" value="<?php echo $nombres ?>" maxlength= "60">
            </div>
            <div class="mb-3">
                <label for="ape_paterno" class="form-label">Apellido Paterno</label>
                <input type="text" class="form-control" id="ape_paterno" name="ape_paterno" value="<?php echo $ape_paterno ?>" maxlength= "40">
            </div>
            <div class="mb-3">
                <label for="ape_materno" class="form-label">Apellido Materno</label>
                <input type="text" class="form-control" id="ape_materno" name="ape_materno" value="<?php echo $ape_materno ?>" maxlength= "40">
            </div>
